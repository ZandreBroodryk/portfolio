...
export default function Home() {
  return (
    <main className="flex flex-col bg-cozy bg-cover bg-fixed bg-center">
      <div className="flex min-h-screen flex-col items-center justify-between p-4 pt-16 before:absolute before:top-0 before:h-full before:w-full before:backdrop-blur-xs md:p-24">
